...
var PolarisConfig = &GenesisConfig{
	...
	GBFT: &VBFTConfig{
		...
		AdminGID:             "GID:ZPT:ZMQjyZSWsVaF45w4QvcAvSDF3jVdz6VFyw",
		...
		Peers: []*VBFTPeerStakeInfo{
			{
				Index:      1,
				PeerPubkey: "034691c558b1cb21af4ad5568fc270b68d9ca46b4a009164b96560beb8ec6648f4",
				Address:    "ZJdfnjpzHLFdNDjyqsQzSxwTzemdfWZ37s",
				InitPos:    10000,
			},
			{
				Index:      2,
				PeerPubkey: "024e8c51fc17f38f0d22c12bb5a4a77571bdbdb0469be11708de26a0a4e219470c",
				Address:    "ZVx294Db2eJNVmitkFa1uxhZXmFvRQf6Ji",
				InitPos:    20000,
			},
			{
				Index:      3,
				PeerPubkey: "02c60f4e52bd57e40ef6002bba4a8421a23df04d6dc7eafadaf99380a68550eaea",
				Address:    "ZTM2cqjwiGtjLCRRm2A7ov7Qz8xnyyRHfa",
				InitPos:    30000,
			},
			{
				Index:      4,
				PeerPubkey: "02deff8eb7bab87cdc5a51e29817765a6a2deff6cc7e0bc95cacc08a1a37fdccda",
				Address:    "ZP2dZz2KakUc7YYBnVEi8f7rDbHXvcxYh3",
				InitPos:    40000,
			},
			{
				Index:      5,
				PeerPubkey: "0359e32a5785442f2cec0606643d4f5a08aec1c27114bbb6c441aaa748e613fd57",
				Address:    "ZYCTd1WvkvdDTpgcZt3JydrUsga8ejah1B",
				InitPos:    30000,
			},
			{
				Index:      6,
				PeerPubkey: "03647b98a8b71b21c1266bfe8b05f19ce3af1180deec6e98b895270cc593f24f2e",
				Address:    "ZD7QRR8gZ5R5F3CRGjhtb1WBusngBKWFDo",
				InitPos:    20000,
			},
			{
				Index:      7,
				PeerPubkey: "02345ed5f44f70a453afbae08af7ec4ce9eb809ce737fd5f478485f8cdc8687401",
				Address:    "ZN8gi7P4zmAHkdmSp4wyafezVjRjQmshBy",
				InitPos:    10000,
			},
			{
				Index:      8,
				PeerPubkey: "036bcdbbd0b22d1a0d3c924c23f4b2d2826c3fda654a46f8906acab90fb7ce58f2",
				Address:    "ZXYxYq7dv3R6VMWqxdfJycgsAB5KMwwfQV",
				InitPos:    2000000,
			},
			{
				Index:      9,
				PeerPubkey: "0392bfab0396a0085af682bf1831b1a2b62e7ca772765654be03c49896582a342f",
				Address:    "ZHW3SB5gTUmnamkCTv3rLNTUegRt2cemMS",
				InitPos:    2000000,
			},
		},
	},
...
var MainNetConfig = &GenesisConfig{
	...
	GBFT: &VBFTConfig{
		...
		AdminGID:             "GID:ZPT:ZRqrcCbuqL4mijFq9vtf1GorkFsdvSWzG",
		MinInitStake:         10000000000,
		VrfValue:             "1c9810aa9822e511d5804a9c4db9dd08497c31087b0daafa34d768a3253441fa20515e2f30f81741102af0ca3cefc4818fef16adb825fbaa8cad78647f3afb590e",
		VrfProof:             "c57741f934042cb8d8b087b44b161db56fc3ffd4ffb675d36cd09f83935be853d8729f3f5298d12d6fd28d45dde515a4b9d7f67682d182ba5118abf451ff1988",
		Peers: []*VBFTPeerStakeInfo{
			{
				Index:      1,
				PeerPubkey: "02bc12d1b94e82f6f69d3c7d83f1498539c70596c7a9a5fec21bc648d88bc30f26",
				Address:    "ZQqjNiFWs4kvbQHx59V6tfSemfWLiLPeHb",
			},
			{
				Index:      2,
				PeerPubkey: "0288ac359e13c88249ccb9afe728023462d728e29668c60de5043ac85b93982d50",
				Address:    "ZUfgQShoyiFyKmU4Y5ivyKUkk35EabJx6r",
			},
			{
				Index:      3,
				PeerPubkey: "03c7ce39956a799c42ea0625f0c8f88b34357767a496fba11d68714ce56ef4f428",
				Address:    "ZG4E3f8MWX7ZPeTC1zc31aWzZbcubh8GHF",
			},
			{
				Index:      4,
				PeerPubkey: "028bf7c2586e623a8d158fb41c15e5e16a41ce5d2f294debc18ecab07a37690d13",
				Address:    "ZWpU6nYagM2xmQCMi4MfMw5hymQVAdHrQ8",
			},
			{
				Index:      5,
				PeerPubkey: "020bdcf198557fb58684f4404f3b9bd5863486b5ca5604dfa1b25718265a07eef1",
				Address:    "ZM87fGvfp2GD6jEo3XasFeoeF5md3o7XSj",
			},
			{
				Index:      6,
				PeerPubkey: "030f130d0e223fd0ba045d6cb50c4508f2f3cab7fd12229d1b814b5a41636ab6c9",
				Address:    "ZWpvT2jen3ynXFLiGbZ2UrEWPyVWcxAUeX",
			},
			{
				Index:      7,
				PeerPubkey: "028da56199ad69a2748b2a75756c4f3487c5de5cb13dcd82f69d36f0c363f1ff65",
				Address:    "ZMNk4YAPiGkiqq31Qw323LMCaAJf4CQ7Bv",
			},
			{
				Index:      8,
				PeerPubkey: "02089bfe8ca8f43aeb5f7b21ffdd4ef45442867e946b9e4ff9be6b04ae6abafcaf",
				Address:    "Zb8M6hdHdgJ1mvb429xYsDnrswkacgYbgs",
			},
			{
				Index:      9,
				PeerPubkey: "02016cf724322d2d7cd0ca78b6f96a9fea3cc5f5a1ca44b5b790d69c56ec4ebca9",
				Address:    "ZETCxn7eGwFBpSzqv3ELv2grd4uu7Y9BCP",
			},
		},
	},
	DBFT: &DBFTConfig{},
