...
func isContractExist(service *EmbeddedService, contractAddress common.Address) error {
...
func storeMigration(service *EmbeddedService, oldAddr common.Address, newAddr common.Address) ([]*scommon.StateItem, error) {
