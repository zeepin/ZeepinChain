...
import (
	...
	vbftconfig "github.com/zeepin/ZeepinChain/consensus/vbft/config"
	cstates "github.com/zeepin/ZeepinChain/core/states"
...
func appCallTransferZpt(native *native.NativeService, from common.Address, to common.Address, amount uint64) error {
	err := appCallTransfer(native, utils.ZptContractAddress, from, to, amount)
	if err != nil {
		return errors.NewDetailErr(err, errors.ErrNoCode, "appCallTransferZpt, appCallTransfer error!")
	}
	return nil
}

func appCallTransferGala(native *native.NativeService, from common.Address, to common.Address, amount uint64) error {
	err := appCallTransfer(native, utils.GalaContractAddress, from, to, amount)
	if err != nil {
		return errors.NewDetailErr(err, errors.ErrNoCode, "appCallTransferGala, appCallTransfer error!")
	}
	return nil
}
...
func appCallTransferFromZpt(native *native.NativeService, sender common.Address, from common.Address, to common.Address, amount uint64) error {
	err := appCallTransferFrom(native, utils.ZptContractAddress, sender, from, to, amount)
	if err != nil {
		return errors.NewDetailErr(err, errors.ErrNoCode, "appCallTransferFromZpt, appCallTransferFrom error!")
	}
	return nil
}

func appCallTransferFromGala(native *native.NativeService, sender common.Address, from common.Address, to common.Address, amount uint64) error {
	err := appCallTransferFrom(native, utils.GalaContractAddress, sender, from, to, amount)
	if err != nil {
		return errors.NewDetailErr(err, errors.ErrNoCode, "appCallTransferFromGala, appCallTransferFrom error!")
	}
	return nil
}
...
func appCallInitContractAdmin(native *native.NativeService, adminGID []byte) error {
	bf := new(bytes.Buffer)
