...
func (this *InitContractAdminParam) Serialize(w io.Writer) error {
	if err := serialization.WriteVarBytes(w, this.AdminGID); err != nil {
		return err
	}
	return nil
}
...
func (this *InitContractAdminParam) Deserialize(rd io.Reader) error {
	var err error
	if this.AdminGID, err = serialization.ReadVarBytes(rd); err != nil {
		return err
	}
	return nil
}
...
func (this *TransferParam) Serialize(w io.Writer) error {
	...
	if err := serialization.WriteVarBytes(w, this.NewAdminGID); err != nil {
		return err
	}
...
func (this *TransferParam) Deserialize(rd io.Reader) error {
	...
	if this.NewAdminGID, err = serialization.ReadVarBytes(rd); err != nil {
		return err
	}
...
func (this *GIDsToRoleParam) Serialize(w io.Writer) error {
	if err := serializeAddress(w, this.ContractAddr); err != nil {
		return err
	}
	if err := serialization.WriteVarBytes(w, this.AdminGID); err != nil {
...
func (this *GIDsToRoleParam) Deserialize(rd io.Reader) error {
	var err error
	var pLen uint64
	if this.ContractAddr, err = utils.ReadAddress(rd); err != nil {
		return err
