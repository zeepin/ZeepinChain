...
func NewInteropService() *InteropService {
	...
	//parameter apis
	service.Register("ZPT_ReadInt32Param", readInt32Param)
	service.Register("ZPT_ReadInt64Param", readInt64Param)
	service.Register("ZPT_ReadStringParam", readStringParam)
	service.Register("ZPT_JsonUnmashalInput", jsonUnmashal)
	service.Register("ZPT_JsonMashalResult", jsonMashal)
	service.Register("ZPT_JsonMashalParams", jsonMashalParams)
	service.Register("ZPT_RawMashalParams", rawMashalParams)
	service.Register("ZPT_GetCallerAddress", getCaller)
	service.Register("ZPT_GetSelfAddress", getContractAddress)
