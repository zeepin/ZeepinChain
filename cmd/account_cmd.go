...
import (
	...
	"github.com/mileschao/ZeepinChain/common/password"
...
You can use ./zeepin account --help command to view help information of wallet management command.`,
   ...
   zeepin support three type of key: ecdsa, sm2 and ed25519, and support 224、256、384、521 bits length of key in ecdsa, but only support 256 bits length of key in sm2 and ed25519.
...
func accountCreate(ctx *cli.Context) error {
	...
	if ctx.Bool(utils.IdentityFlag.Name) {
		...
		if err != nil {
			return fmt.Errorf("Create GID error: %s", err)
		}
		wd.AddIdentity(id)
