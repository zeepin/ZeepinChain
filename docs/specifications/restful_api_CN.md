...
本文档是zeepin的REST接口文档，详细定义了各个接口所需的参数与返回值。
...
| [get_unboundgala](#18-get_unboundgala) | GET /api/v1/unboundgala/:addr | 返回该账户未提取的gala数量 |
...
| [post_raw_tx](#22-post_raw_tx) | post /api/v1/transaction?preExec=0 | 向zeepin网络发送交易 |
...
```
可以使用zeepin-go-sdk生成十六进制数据，参考这个[例子](rpc_api_CN.md#8-sendrawtransaction)
