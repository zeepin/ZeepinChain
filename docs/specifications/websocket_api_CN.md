...
本文档是zeepin的websocket接口文档，详细定义了各个接口所需的参数与返回值。
...
| [sendrawtransaction](#11-sendrawtransaction) | data,[PreExec] | 向zeepin网络发送交易, 如果 preExec=1，则交易为预执行 |
...
| [getunboundgala](#22-getunboundgala) | address | 返回该账户未提取的gala数量 |
